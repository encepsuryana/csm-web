					...
					<div class="box-body table-responsive">
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea class="form-control" name="mk_electronics_division_desc" style="height:60px;"><?php echo $electronics_division_desc['mk_electronics_division_desc']; ?></textarea>
								</div>
							</div>  
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Meta Description </label>
								<div class="col-sm-9">
									<textarea class="form-control" name="md_electronics_division_desc" style="height:60px;"><?php echo $electronics_division_desc['md_electronics_division_desc']; ?></textarea>
								</div>
							</div>  
							<div class="form-group">
								<label for="" class="col-sm-2 control-label"></label>

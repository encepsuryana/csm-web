...
<?php if (($this->session->userdata('role') == 'admin') or ($this->session->userdata('role') == 'staff') or ($this->session->userdata('role') == 'hrd')) { ?>
	<section class="content-header">
		...
		<div class="content-header-right">
			<a href="<?php echo base_url().$this->session->userdata('role'); ?>/aeronautical-electronics-engineering" class="btn btn-primary btn-sm">Lihat Semua</a>
		</div>
	</section>
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php echo form_open_multipart(base_url().$this->session->userdata('role').'/aeronautical-electronics-engineering/edit/'.$aviation_electronics['id'],array('class' => 'form-horizontal')); ?>

...
<?php if (($this->session->userdata('role') == 'admin') or ($this->session->userdata('role') == 'staff') or ($this->session->userdata('role') == 'hrd')) { ?>
	<section class="content-header">
		...
		<div class="content-header-right">
			<a href="<?php echo base_url().$this->session->userdata('role'); ?>/facility" class="btn btn-primary btn-sm">View All</a>
		</div>
	</section>
				...
				<div class="box box-info  b-box">
					<div class="box-body">						
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="heading" value="<?php echo $facility['heading']; ?>">
							</div>
						</div>			
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Style *</label>
							<div class="col-sm-6">
								<input id="style" readonly="readonly" type="text" autocomplete="off" class="form-control" name="facility_style" value="<?php echo $facility['facility_style']; ?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px;">
								<img src="<?php echo base_url(); ?>public/uploads/<?php echo $facility['photo']; ?>" alt="facility Photo" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px;">
								<img src="<?php echo base_url(); ?>public/uploads/<?php echo $facility['banner']; ?>" alt="facility Banner Photo" style="width:400px;">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control" name="short_content" style="height:140px;"><?php echo $facility['short_content']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="meta_title" value="<?php echo $facility['meta_title']; ?>">
							</div>
						</div>
						<div class="form-group">

...
<?php if (($this->session->userdata('role') == 'admin') or ($this->session->userdata('role') == 'staff') or ($this->session->userdata('role') == 'hrd')) { ?>
	<section class="content-header">
		...
		<div class="content-header-right">
			<a href="<?php echo base_url().$this->session->userdata('role'); ?>/aviation-electronics-department-category" class="btn btn-primary btn-sm">Lihat Semua</a>
		</div>
	</section>
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php echo form_open(base_url().$this->session->userdata('role').'/aviation-electronics-department-category/edit/'.$aviation_electronics_category['category_id'],array('class' => 'form-horizontal')); ?>

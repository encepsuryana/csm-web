		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<div class="col-md-4 col-sm-4 bg-about" style="padding: 5px">
						<div class="ciptasin-spanduk-download">
							<a href="<?php echo base_url();?>download/file-electronic" style="background-image: url(<?php echo base_url(); ?>public/uploads/file/<?php echo $content_home['spanduk2']; ?>);" title="<?php echo CLICK_FOR_DOWNLOAD; ?>: <?php echo COMPANY_PROFILE_ELECTRONICS_DIVISION; ?>" data-toggle="tooltip" data-placement="top">

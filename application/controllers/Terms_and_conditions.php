...
class Terms_and_conditions extends CI_Controller {
	...
	public function index()
	{
		...
		$header['electronics_division'] = $this->Model_term->get_electronics_division_data();
		$header['electronics_division_category'] = $this->Model_term->get_electronics_division_category();

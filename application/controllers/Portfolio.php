...
class Portfolio extends CI_Controller {
	...
	public function index()
	{
		...
		$header['aviation_electronics'] = $this->Model_portfolio->get_aviation_electronics_data();
		$header['aviation_electronics_category'] = $this->Model_portfolio->get_aviation_electronics_category();

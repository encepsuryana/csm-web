...
insert  into `tbl_content_home`(`id`,`photo`,`heading`,`content`,`link`) values (1,'content-home-1.png','fa-cloud-download','Company Profile','download'),(2,'content-home-2.png','fa-archive','Our Products','product'),(3,'content-home-3.png','fa-briefcase','Career','ciptasinergi-career.html'),(4,'content-home-4.png','fa-industry','Facility','facility');
...
insert  into `tbl_content_home_company_profile`(`id`,`item_bg`) values (1,'Company_profile.pdf');
...
insert  into `tbl_electronics_division`(`id`,`name`,`short_content`,`content`,`client_name`,`client_company`,`start_date`,`end_date`,`website`,`cost`,`client_comment`,`category_id`,`photo`,`meta_title`,`meta_keyword`,`meta_description`,`slug_electronics`) values (1,'PLC Controller design and implementations','PLC Controller design and implementations','<p>PLC Controller design and implementations<br></p>','','','','','','','','1','electronics_division-1.jpg','PLC Controller design and implementations','PLC Controller design and implementations','PLC Controller design and implementations','plc-controller-design-and-implementations.html'),(2,'Power electronics design and manufacturing','Power electronics design and manufacturing','<p>Power electronics design and manufacturing <br></p>','','','','','','','','1','electronics_division-2.jpg','Power electronics design and manufacturing ','Power electronics design and manufacturing ','Power electronics design and manufacturing ','power-electronics-design-and-manufacturing.html'),(3,'Man-Machine Interface','MMI (Man-Machine Interface)','<p>MMI (Man-Machine Interface)<br></p>','','','','','','','','1','electronics_division-3.jpg','MMI (Man-Machine Interface)','MMI (Man-Machine Interface)','MMI (Man-Machine Interface)','man-machine-interface.html'),(4,'Ruggedized electronic controllers','Ruggedized electronic controllers','<p>Ruggedized electronic controllers<br></p>','','','','','','','','2','electronics_division-4.jpg','Ruggedized electronic controllers','Ruggedized electronic controllers','Ruggedized electronic controllers','ruggedized-electronic-controllers.html'),(5,'Harsh environmental power drivers','Harsh environmental power drivers','<p>Harsh environmental power drivers <br></p>','','','','','','','','2','electronics_division-5.jpg','Harsh environmental power drivers ','Harsh environmental power drivers ','Harsh environmental power drivers ','harsh-environmental-power-drivers.html'),(6,'Mission computers','Mission computers','<p>Mission computers <br></p>','','','','','','','','3','electronics_division-6.jpg','Mission computers ','Mission computers ','Mission computers ','mission-computers.html'),(7,'Display systems Multi-Function Display-MFD Moving Map Display etc','Display systems (Multi-Function Display-MFD, Moving Map Display, etc)','Display systems (Multi-Function Display-MFD, Moving Map Display, etc)','','','','','','','','3','electronics_division-7.jpg','Display systems (Multi-Function Display-MFD, Moving Map Display, etc)','Display systems (Multi-Function Display-MFD, Moving Map Display, etc)','Display systems (Multi-Function Display-MFD, Moving Map Display, etc)','display-systems-multi-function-display-mfd-moving-map-display-etc.html'),(8,'Sensor interface units','Sensor interface units','<p>Sensor interface units <br></p>','','','','','','','','3','electronics_division-8.jpg','Sensor interface units ','Sensor interface units ','Sensor interface units ','sensor-interface-units.html');
...
insert  into `tbl_electronics_division_category`(`category_id`,`category_name`,`status`) values (1,'Industrial Electronics','Active'),(2,'Defense Electronic','Active'),(3,'Aviation Electronics','Active');
...
insert  into `tbl_facility_category`(`category_id`,`category_name`,`status`) values (1,'Workshop','Active'),(2,'Office','Active'),(3,'Land','Active');
...
insert  into `tbl_facility_photo`(`id`,`facility_id`,`photo`) values (2,2,'2.png'),(3,2,'3.png'),(4,1,'4.jpg'),(5,2,'5.jpg'),(6,3,'6.jpg'),(7,4,'7.jpg'),(8,5,'8.jpg'),(9,6,'9.jpg');
...
insert  into `tbl_language`(`id`,`name`,`eng`,`idn`) values (1,'HOME','Home','Beranda'),(2,'PAGE','Page','Halaman'),(3,'ABOUT','About','Tentang'),(4,'GALLERY','Gallery','Galeri'),(5,'FAQ','FAQ','FAQ'),(6,'SERVICE','Service','layanan'),(7,'PORTFOLIO','Portfolio','Portofolio'),(8,'TESTIMONIAL','Testimonial','Testimonial'),(9,'NEWS','News','Berita'),(10,'CONTACT','Contact','Kontak'),(11,'ADDRESS','Address','Alamat'),(12,'CALL_US','Call Us','Hubungi Kami'),(13,'WORKING_HOURS','Woring Hours','Jam Kerja'),(14,'ABOUT_US','About Us','Tentang Kami'),(15,'LATEST_NEWS','Latest News','Berita Terbaru'),(16,'POPULAR_NEWS','Popular News','Berita Poluler'),(17,'QUICK_LINKS','Quick Link','Quick Link'),(18,'TERMS_AND_CONDITIONS','Term and Conditions','Term and Conditions'),(19,'PRIVACY_POLICY','Privacy Policy','Privacy Policy'),(20,'READ_MORE','Read More','Selengkapnya'),(21,'POSTED_ON','Posted On:','Posting pada:'),(22,'ADMIN','Admin','Admin'),(23,'SERVICES','Services','Layanan Kami'),(24,'ALL','All','Semua'),(26,'PROJECTS','Project','Proyek'),(27,'DESCRIPTION','Description','Deskripsi'),(28,'CLIENT_NAME','Client Name','Nama klien'),(29,'CLIENT_COMPANY','Client Company','Perusahaan Klien'),(30,'PROJECT_START_DATE','Project Start Date','Waktu Mulai Proyek'),(31,'PROJECT_END_DATE','Project End Date','Waktu Selesai Proyek'),(33,'CLIENT_COMMENT','Client Comment','Komentar Klien'),(34,'SEARCH_NEWS','Search News','Pencarian Berita'),(35,'CATEGORY','Category','Kategori'),(36,'SHARE_THIS','Share This','Bagikan ini'),(37,'COMMENTS','Comments','Komentar'),(38,'SEARCH_BY','Search by:','Pencarian Berdasarkan:'),(39,'NO_RESULT_FOUND','No Result Found','Pencarian tidak ditemukan'),(40,'CONTACT_US_PAGE_FORM_HEADING_TEXT','Contact us through the following form:','Kontak kami melalui form berikut:'),(41,'PREVIOUS','Previos','Sebelumnya'),(42,'NEXT','Next','Selanjutnya'),(43,'FIND_US_ON_MAP','Find Us on Map:','Tentukan Kami di Maps:'),(44,'NAME','Name','Nama'),(45,'EMAIL_ADDRESS','Email Address','Alamat Email'),(46,'PHONE','Phone Number','Nomor Telp'),(47,'MESSAGE','Message','Pesan'),(48,'SEND_MESSAGE','Send Message','Kirim Pesan'),(49,'EMPTY_ERROR_NAME','Name can not be empty','Nama tidak boleh kosong!'),(50,'EMPTY_ERROR_PHONE','Phone number can not be empty','Telp tidak boleh kosong!'),(51,'EMPTY_ERROR_EMAIL','Email address can not be empty','Alamat Email tidak boleh kosong!'),(52,'VALID_ERROR_EMAIL','Email address is invalid','Alamat Email tidak benar!'),(53,'EMPTY_ERROR_COMMENT','Comment can not be empty','Komentar tidak boleh kosong!'),(54,'CONTACT_FORM_EMAIL_SUBJECT','Contact Form Email - www.ciptasinergi.com','Pesan dari Email - www.ciptasinergi.com'),(55,'CONTACT_FORM_EMAIL_SUCCESS_MESSAGE','Thank you for sending us the email. We will contact you shortly.','Terima kasih telah mengirim pesan, tunggu balasan dari kami..'),(56,'PASSWORD_REQUEST_EMAIL_SUBJECT','Password Request - www.ciptasinergi.com','Password Request -  www.ciptasinergi.com'),(57,'PRODUCT','Product','Produk'),(58,'COMPANY_PROFILE','Company Profile','Profil Perusahaan'),(59,'CAREER','Career','Karir'),(60,'OUR_PRODUCT','Our Product','Produk Kami'),(61,'FACILITY','Facility','Fasilitas'),(62,'SEE_MORE','See More','Lihat Semua'),(63,'COMPANY_EMAIL','Company Email','Email Perusahaan'),(64,'COMPANY_PHONE','Company Phone','No.Telp Perusahaan'),(65,'ELECTRONICS_DIVISION','Electronics Division','Divisi Elektronik'),(66,'NEW_PRODUCT','New Product','Produk Baru'),(67,'TESTIMONIAL_SAY','What a Client Say','Apa yang klien katakan '),(68,'PRODUCT_HOME','Our Featured Products','Produk Unggulan Kami'),(69,'OUR_PARTNER','Our Partner','Partner Kami'),(70,'OUR_FUTURE_PRODUCT','Our Future Product','Produk Unggulan Kami\r\n'),(71,'INSTITUTE','Institute / Company','Institut / Perusahaan'),(72,'HAVE_A_MORE_QUETIONS','Have more questions? Just Contact Us','Punya pertanyaan lain? Hubungi Kami'),(73,'PROFILE','Profile','Profil'),(74,'STRUCTURE','Structure','Struktur'),(75,'CULTURE','Values and Culture','Nilai dan Budaya'),(76,'COMMITMENT','Quality commitment','Komitmen Mutu'),(77,'VISION_MISION','Vision & Mission','Visi & Misi'),(78,'PROFILE_IDENTITY','Company Identity','Identitas Perusahaan'),(79,'STRUCTURE_ORGANIZATION','Structure Organization','Struktur Organisasi'),(80,'VISION_AND_MISSION','Vision & Mission','Visi & Misi'),(81,'ABOUT_COMPANY','About Company Us','Tentang Perusahaan Kami');
...
insert  into `tbl_news_category`(`category_id`,`category_name`,`meta_title`,`meta_keyword`,`meta_description`,`slug_news_category`) values (1,'New Product','New Product','','','new-product.html'),(2,'New Project','New Project','','','new-project.html'),(3,'Project Finish','Project Finish','','','project-finish.html'),(4,'Activity','Activity','','','activity.html'),(5,'Announcement','Announcement','','','announcement.html'),(7,'Career','Career','','','career.html'),(8,'Event','Event','','','event.html');
...
insert  into `tbl_partner`(`id`,`name`,`photo`) values (1,'Perfetti Van Melle Indonesia','partner-1.png'),(2,'Pakoakuina Group','partner-2.png'),(3,'PT. INFRA RCS','partner-3.png'),(4,'PT. Medion Jaya Farma','partner-4.png'),(5,'PT. Hini Daiki Indonesia','partner-5.png'),(6,'PT. Madawikri Tunggal','partner-6.png'),(7,'PT. Belfoods Indonesia','partner-7.png'),(8,'PT Nusantara Turbin Dan Propulsi','partner-8.png');
...
insert  into `tbl_photo`(`photo_id`,`photo_caption`,`photo_style`,`photo_name`,`photo_desc`,`photo_show_home`) values (1,'Touring Ciletuh 2017','col-sm-6 col-xs-6 box','photo-1.jpg','Foto Bersama dibukit pinggir pantai Ciletuh - Sukabumi dalam acara touring karyawan CV. Cipta Sinergi Manufacturing tahun 2017','Yes'),(2,'Kebersamaan di Ciletuh 2017','col-sm-3 col-xs-6 box','photo-2.jpg','Istirahat sejenak sebelum melanjutkan perjalanan ke Ciletuh - Sukabumi dalam acara Touring Karyawan CV. Cipta Sinergi Manufacturing 2017','Yes'),(4,'Pameran Manufaktur 2018','col-sm-3 col-xs-6 box','photo-4.jpg','Menghadiri Pameran Manufacturing dalam acara JIEXPO Manufacturing Indonesia 2018 di Jakarta','Yes'),(5,'Pameran Manufaktur 2018 (2)','col-sm-3 col-xs-6 box','photo-5.jpg','Menghadiri Pameran Manufacturing dalam acara JIEXPO Manufacturing Indonesia 2018 di Jakarta','Yes'),(6,'Pameran Manufaktur 2018 (3)','col-sm-6 col-xs-6 box','photo-6.jpg','Team yang menghadiri Pameran Manufacturing dalam acara JIEXPO Manufacturing Indonesia 2018 di Jakarta','Yes'),(7,'Pameran Manufaktur 2018 (4)','col-sm-3 col-xs-6 box','photo-7.jpg','Menghadiri Pameran Manufacturing dalam acara JIEXPO Manufacturing Indonesia 2018 di Jakarta','Yes'),(8,'Touring Pangandaran 2018','col-sm-6 col-xs-6 box','photo-8.jpg','Foto bersama di halaman CV. Cipta Sinergi Manufacturing sebelum berangkat ke pantai Pangandaran dalam kegiatan Touring Karyawan CV. Cipta Sinergi Manufacturing 2018','Yes'),(9,'Touring Pangandaran 2018 (2)','col-sm-3 col-xs-6 box','photo-9.jpg','Kegiatan saat Touring ke Pantai Pangandaran dalam acra Touring Karyawan CV. Cipta Sinergi Manufacturing 2018','Yes'),(10,'Touring Pangandaran 2018 (3)','col-sm-3 col-xs-6 box','photo-10.jpg','Kegiatan bersama karyawan CV. Cipta Sinergi Manufacturing dalam kegiatan Touring Karyawan CV. Cipta Sinergi Manufacturing ke Pangandaran 2018','Yes'),(11,'Touring Pangandaran 2018 (4)','col-sm-6 col-xs-6 box','photo-11.jpg','Foto bersama karyawan CV. Cipta Sinergi Manufacturing di pantai Pangandaran dalam kegiatan Touring Karyawan CV. Cipta Sinergi Manufacturing 2018','Yes'),(12,'Idul Adha 2019','col-sm-3 col-xs-6 box','photo-12.jpg','Sapi Qurban CV. Cipta Sinergi Manufacturing dalam memperingati hari raya Idul Adha 2019 di lapangan CV. Cipta Sinergi Manufacturing','Yes'),(13,'Idul Adha 2019 (2)','col-sm-3 col-xs-6 box','photo-13.jpg','Pemotongan Sapi Qurban CV. Cipta Sinergi Manufacturing dalam memperingati hari raya Idul Adha 2019 di lapangan CV. Cipta Sinergi Manufacturing','Yes'),(14,'Idul Adha 2019 (3)','col-sm-3 col-xs-6 box','photo-14.jpg','Prosesn Pemotongan Sapi Qurban CV. Cipta Sinergi Manufacturing dalam memperingati hari raya Idul Adha 2019 di lapangan CV. Cipta Sinergi Manufacturing','Yes'),(15,'Idul Adha 2019 (4)','col-sm-3 col-xs-6 box','photo-15.jpg','Proses Pengolahan dan pemotongan daging sapi Qurban CV. Cipta Sinergi Manufacturing dalam memperingati hari raya Idul Adha 2019 di lapangan CV. Cipta Sinergi Manufacturing','Yes'),(16,'Idul Adha 2019 (5)','col-sm-6 col-xs-6 box','photo-16.jpg','Proses pembagian daging sapi Qurban CV. Cipta Sinergi Manufacturing dalam memperingati hari raya Idul Adha 2019 di lapangan CV. Cipta Sinergi Manufacturing','Yes'),(17,'Not just a team, it\'s SQUAD','col-sm-6 col-xs-6 box','photo-17.jpeg','Not just a team, it\'s SQUAD','Yes'),(18,'Manufacturing is dancing','col-sm-3 col-xs-6 box','photo-18.jpeg','Manufacturing is dancing','Yes'),(19,'Penghormatan Bendera Merah Putih','col-sm-3 col-xs-6 box','photo-19.jpeg','Penghormatan Bendera Merah Putih','Yes'),(20,'Family Gathering','col-sm-6 col-xs-6 box','photo-20.jpeg','Family Gathering','Yes'),(21,'Family Gathering','col-sm-6 col-xs-6 box','photo-21.jpeg','Family Gathering','Yes'),(22,'Family Gathering','col-sm-3 col-xs-6 box','photo-22.jpeg','Family Gathering','Yes'),(23,'Family Gathering','col-sm-6 col-xs-6 box','photo-23.jpeg','Family Gathering','Yes'),(24,'Family Gathering','col-sm-3 col-xs-6 box','photo-24.jpeg','Family Gathering','Yes');
...
insert  into `tbl_portfolio`(`id`,`name`,`short_content`,`content`,`client_name`,`client_company`,`start_date`,`end_date`,`website`,`cost`,`client_comment`,`category_id`,`photo`,`meta_title`,`meta_keyword`,`meta_description`,`slug_portfolio`) values (1,'FOOD BEVERAGE','In the production process not only made industrial equipment, but the entirety of the customer demand is definitely there.','In the production process not only made industrial equipment, but the entirety of the customer demand is definitely there. of the completeness of the manufacturing infrastructure of food, mold and other requirements we are ready to serve','-','-','7-01-08','10-01-08','-','-','manufacture and production of reliable, high-quality products.','1','portfolio-1.jpg','FOOD BEVERAGE','','','food-beverage.html'),(2,'AUTOMOTIVE','Our production process has always relied on customer satisfaction, and where all the requests of customers we serve, as well as in the manufacture of parts or the whole of the automotive','Our production process has always relied on customer satisfaction, and where all the requests of customers we serve, as well as in the manufacture of automotive parts or in whole. ranging from the mold and the material basis of our own manufacture of ready made','-','-','2019-08-29','2019-08-29','-','-','Ancillae interpretaris ea has. Id amet impedit qui, eripuit mnesarchum percipitur in eam. Ne sit habeo inimicus, no his liber regione volutpat. Ex quot voluptaria usu, dolor vivendo docendi nec ea. Et atqui vocent integre vim, quod cibo recusabo ei usu, soleat deseruisse percipitur pri no. Aeterno theophrastus id pro.','1','portfolio-2.jpg','AUTOMOTIVE','','','automotive.html'),(3,'MECHANICAL SYSTEM OF RADAR','Not just rely on the industry and we are also ready to assist the government and in the defense and security of the country.','Not just rely on the industry and we are also ready to assist the government and in the defense and security of the country. to assist in making the national radar, we are ready to strengthen the resilience and security of the country.','-','-','08-04-2018','22-06-2018','-','-','Ancillae interpretaris ea has. Id amet impedit qui, eripuit mnesarchum percipitur in eam. Ne sit habeo inimicus, no his liber regione volutpat. Ex quot voluptaria usu, dolor vivendo docendi nec ea. Et atqui vocent integre vim, quod cibo recusabo ei usu, soleat deseruisse percipitur pri no. Aeterno theophrastus id pro.','2','portfolio-3.jpg','MECHANICAL SYSTEM OF RADAR','','','mechanical-system-of-radar.html'),(4,'COCKPIT SIMULATOR','Improving our service also makes a Head-Up Display (HUD) for the purposes of the cockpit Casing simulator.','Improving our service also makes a Head-Up Display (HUD) for the purposes of the cockpit Casing simulator.','-','-','2019-08-29','2019-08-29','-','-','Ancillae interpretaris ea has. Id amet impedit qui, eripuit mnesarchum percipitur in eam. Ne sit habeo inimicus, no his liber regione volutpat. Ex quot voluptaria usu, dolor vivendo docendi nec ea. Et atqui vocent integre vim, quod cibo recusabo ei usu, soleat deseruisse percipitur pri no. Aeterno theophrastus id pro.','3','portfolio-4.jpg','COCKPIT SIMULATOR','','','cockpit-simulator.html'),(5,'RADAR DISPLAY UNIT CASING','Improving our service also makes Radar Display Unit (RDU) Casing for the purposes of cockpit simulator','in improving our service also makes Radar Display Unit (RDU) Casing for the purposes of cockpit simulator','-','-','15-06-2018','05-07-2018','-','-','Ancillae interpretaris ea has. Id amet impedit qui, eripuit mnesarchum percipitur in eam. Ne sit habeo inimicus, no his liber regione volutpat. Ex quot voluptaria usu, dolor vivendo docendi nec ea. Et atqui vocent integre vim, quod cibo recusabo ei usu, soleat deseruisse percipitur pri no. Aeterno theophrastus id pro.','3','portfolio-5.jpg','RADAR DISPLAY UNIT CASING','','','radar-display-unit-casing.html');
...
insert  into `tbl_portfolio_category`(`category_id`,`category_name`,`status`) values (1,'Industrial','Active'),(2,'Military','Active'),(3,'Aviation','Active');
...
insert  into `tbl_portfolio_photo`(`id`,`portfolio_id`,`photo`) values (17,1,'17.jpg'),(18,1,'18.jpg'),(19,2,'19.jpg'),(20,2,'20.jpg'),(21,2,'21.jpg'),(22,2,'22.jpg'),(23,3,'23.jpg'),(24,3,'24.jpg'),(25,3,'25.jpg'),(26,4,'26.jpg'),(27,4,'27.jpg'),(28,5,'28.jpg');
...
insert  into `tbl_product`(`product_id`,`product_caption`,`product_style`,`product_name`,`product_desc`,`product_show_home`) values (1,'Air Nozzle Boiler','col-sm-3 col-xs-6 box','product-1.jpg','Air Nozzle Boiler','Yes'),(2,'Air Nozzle for Boiler','col-sm-3 col-xs-6 box','product-2.jpg','Air Nozzle for Boiler','Yes'),(3,'Arm Machining Part','col-sm-6 col-xs-6 box','product-3.jpg','Arm Machining Part','Yes'),(4,'Aviation Modul Part assy','col-sm-6 col-xs-6 box','product-4.jpg','Aviation Modul Part assy','Yes'),(5,'Bal Valve','col-sm-3 col-xs-6 box','product-5.jpg','Bal Valve','Yes'),(6,'Ball Valve - Up','col-sm-3 col-xs-6 box','product-6.jpg','Ball Valve - Up','Yes'),(7,'BOTTLE YAMALUBE 600ML BLOW MOLD','col-sm-3 col-xs-6 box','product-7.jpg','BOTTLE YAMALUBE 600ML BLOW MOLD','Yes'),(8,'Cam machining','col-sm-3 col-xs-6 box','product-8.jpg','Cam machining','Yes'),(9,'Can Scroll Cutter set','col-sm-6 col-xs-6 box','product-9.jpg','Can Scroll Cutter set','Yes'),(10,'Car Wheel Cavity Mold AHT','col-sm-3 col-xs-6 box','product-10.jpg','Car Wheel Cavity Mold AHT','Yes'),(11,'Car Wheel Cavity Mold with Insert Core Cavity','col-sm-3 col-xs-6 box','product-11.jpg','Car Wheel Cavity Mold with Insert Core Cavity','Yes'),(12,'Car Wheel Cavity Mold','col-sm-6 col-xs-6 box','product-12.jpg','Car Wheel Cavity Mold','Yes'),(13,'Casting Mold Cavity','col-sm-3 col-xs-6 box','product-13.jpg','Casting Mold Cavity','Yes'),(14,'Casting Sand Core Mold','col-sm-6 col-xs-6 box','product-14.jpg','Casting Sand Core Mold','Yes'),(15,'Cavity CNC Machining Part','col-sm-3 col-xs-6 box','product-15.jpg','Cavity CNC Machining Part','Yes'),(16,'Cavity for Casting Sand Core','col-sm-3 col-xs-6 box','product-16.jpg','Cavity for Casting Sand Core','Yes'),(17,'Cavity for Casting Sand Core-1','col-sm-3 col-xs-6 box','product-17.jpg','Cavity for Casting Sand Core-1','Yes'),(18,'Cavity for Casting Sand Core-2','col-sm-6 col-xs-6 box','product-18.jpg','Cavity for Casting Sand Core-2','Yes'),(19,'Cockpit Module Case','col-sm-3 col-xs-6 box','product-19.jpg','Cockpit Module Case','Yes'),(20,'Cockpit Module Case - rear','col-sm-3 col-xs-6 box','product-20.jpg','Cockpit Module Case - rear','Yes'),(21,'Feeder Conveyor Unit','col-sm-6 col-xs-6 box','product-21.jpg','Feeder Conveyor Unit','Yes'),(22,'Food Processing Part - Mold Plate','col-sm-3 col-xs-6 box','product-22.jpg','Food Processing Part - Mold Plate','Yes'),(23,'Food Processing Part - Steel Mold Plate','col-sm-3 col-xs-6 box','product-23.jpg','Food Processing Part - Steel Mold Plate','Yes'),(24,'Horn Antena Radar - Front','col-sm-3 col-xs-6 box','product-24.jpg','Horn Antena Radar - Front','Yes'),(25,'Horn Antena Radar - Upper','col-sm-3 col-xs-6 box','product-25.jpg','Horn Antena Radar - Upper','Yes'),(26,'Housing Pump','col-sm-6 col-xs-6 box','product-26.jpg','Housing Pump','Yes'),(27,'Individual Feeder System','col-sm-6 col-xs-6 box','product-27.jpg','Individual Feeder System','Yes'),(28,'Jig For Machining Process','col-sm-3 col-xs-6 box','product-28.jpg','Jig For Machining Process','Yes'),(29,'Lot Mark Holder SA25&#5 PAKO Karwheel - Closer','col-sm-3 col-xs-6 box','product-29.jpg','Lot Mark Holder SA25&#5 PAKO Karwheel - Closer','Yes'),(30,'Lot Mark Holder SA25&#5 PAKO Karwheel','col-sm-3 col-xs-6 box','product-30.jpg','Lot Mark Holder SA25&#5 PAKO Karwheel','Yes'),(31,'Lot Mark Koja FR#7 PAKO Motorcycle M6 - Closer','col-sm-3 col-xs-6 box','product-31.jpg','Lot Mark Koja FR#7 PAKO Motorcycle M6 - Closer','Yes'),(32,'Lot Mark Koja FR#7 PAKO Motorcycle M6','col-sm-6 col-xs-6 box','product-32.jpg','Lot Mark Koja FR#7 PAKO Motorcycle M6','Yes'),(33,'MDM Food Processing Part','col-sm-3 col-xs-6 box','product-33.jpg','MDM Food Processing Part','Yes'),(34,'MDM Food Processing Part-Blade','col-sm-3 col-xs-6 box','product-34.jpg','MDM Food Processing Part-Blade','Yes'),(35,'MDM Food Processing Part-Filter','col-sm-3 col-xs-6 box','product-35.jpg','MDM Food Processing Part-Filter','Yes'),(36,'Plastic Mold Set','col-sm-3 col-xs-6 box','product-36.jpg','Plastic Mold Set','Yes'),(37,'Pump Lube Part - with wear plate','col-sm-6 col-xs-6 box','product-37.jpg','Pump Lube Part - with wear plate','Yes'),(38,'Pump Lube Part','col-sm-3 col-xs-6 box','product-38.jpg','Pump Lube Part','Yes'),(39,'Pump Part - Lube','col-sm-3 col-xs-6 box','product-39.jpg','Pump Part - Lube','Yes'),(40,'Pump Part - Metering gear','col-sm-6 col-xs-6 box','product-40.jpg','Pump Part - Metering gear','Yes'),(41,'Radar Component','col-sm-3 col-xs-6 box','product-41.jpg','Radar Component','Yes'),(42,'Radar Component Rear','col-sm-3 col-xs-6 box','product-42.jpg','Radar Component Rear','Yes'),(43,'Radar Component Closer','col-sm-3 col-xs-6 box','product-43.jpg','Radar Component Closer','Yes'),(44,'ROLLER POM BLACK','col-sm-3 col-xs-6 box','product-44.jpg','ROLLER POM BLACK','Yes'),(45,'ROTARY CLEANER MACHINE','col-sm-3 col-xs-6 box','product-45.jpg','ROTARY CLEANER MACHINE','Yes'),(46,'Rotary Forming Part - Plunger','col-sm-6 col-xs-6 box','product-46.jpg','Rotary Forming Part - Plunger','Yes'),(47,'Rotary Table','col-sm-3 col-xs-6 box','product-47.jpg','Rotary Table','Yes'),(48,'Rotary Table - Rear','col-sm-3 col-xs-6 box','product-48.jpg','Rotary Table - Rear','Yes'),(49,'Rotary Table - Closer','col-sm-3 col-xs-6 box','product-49.jpg','Rotary Table - Closer','Yes'),(50,'SHAFT PN 7 Bearing Housing','col-sm-6 col-xs-6 box','product-50.jpg','SHAFT PN 7 Bearing Housing','Yes'),(51,'SHAFT PN 7 Bearing Housing - Closer rear','col-sm-3 col-xs-6 box','product-51.jpg','SHAFT PN 7 Bearing Housing - Closer rear','Yes'),(52,'SHAFT PN 7 Bearing Housing - Closer rear','col-sm-3 col-xs-6 box','product-52.jpg','SHAFT PN 7 Bearing Housing - Closer rear','Yes'),(53,'Short Plunger Eclair','col-sm-6 col-xs-6 box','product-53.jpg','Short Plunger Eclair','Yes'),(54,'Short Plunger Eclair - Closer','col-sm-3 col-xs-6 box','product-54.jpg','Short Plunger Eclair - Closer','Yes'),(55,'Side Conveyor','col-sm-3 col-xs-6 box','product-55.jpg','Side Conveyor','Yes'),(56,'Side Conveyor - Rear','col-sm-3 col-xs-6 box','product-56.jpg','Side Conveyor - Rear','Yes'),(57,'Slab Blind Bottling Marble Beat','col-sm-3 col-xs-6 box','product-57.jpg','Slab Blind Bottling Marble Beat','Yes'),(58,'Slab Blind Bottling Marble Beat - Closer','col-sm-6 col-xs-6 box','product-58.jpg','Slab Blind Bottling Marble Beat - Closer','Yes'),(59,'Slab Blind Bottling Marble Beat - Closer-1','col-sm-6 col-xs-6 box','product-59.jpg','Slab Blind Bottling Marble Beat - Closer-1','Yes'),(60,'Slab Bottle in Line3x7 Marbel Beat','col-sm-3 col-xs-6 box','product-60.jpg','Slab Bottle in Line3x7 Marbel Beat','Yes'),(61,'Slab Bottle in Line3x7 Marbel Beat - Closer','col-sm-3 col-xs-6 box','product-61.jpg','Slab Bottle in Line3x7 Marbel Beat - Closer','Yes'),(62,'SPRAY BOTTLE 500ML BLOW MOLD','col-sm-6 col-xs-6 box','product-62.jpg','SPRAY BOTTLE 500ML BLOW MOLD','Yes'),(63,'Transfer Pump','col-sm-3 col-xs-6 box','product-63.jpg','Transfer Pump','Yes'),(64,'Turbine Impeller assy','col-sm-3 col-xs-6 box','product-64.jpg','Turbine Impeller assy','Yes'),(65,'Turbine Impeller','col-sm-6 col-xs-6 box','product-65.jpg','Turbine Impeller','Yes'),(66,'Electronic Support Measures (ESM) - Without Cover','col-sm-3 col-xs-6 box','product-66.jpg','ELectronic INTelligence primarily dedicated to the interception and analysis of radar emissions from surveillance, fire-control or missile guidance radars, and is often allied to an ECM system to provide protection from these.','Yes'),(67,'Electronic Support Measures (ESM) - With Cover','col-sm-3 col-xs-6 box','product-67.jpg','ELectronic INTelligence primarily dedicated to the interception and analysis of radar emissions from surveillance, fire-control or missile guidance radars, and is often allied to an ECM system to provide protection from these.','Yes'),(68,'Electronic Support Measures (ESM)','col-sm-6 col-xs-6 box','product-68.jpg','ELectronic INTelligence primarily dedicated to the interception and analysis of radar emissions from surveillance, fire-control or missile guidance radars, and is often allied to an ECM system to provide protection from these.','Yes'),(69,'Knife Pocket - Upper','col-sm-6 col-xs-6 box','product-69.jpg','Knife Pocket - Upper','Yes'),(70,'Knife Pocket - side by side','col-sm-3 col-xs-6 box','product-70.jpg','Knife Pocket - side by side','Yes'),(71,'Knife Pocket - Side','col-sm-3 col-xs-6 box','product-71.jpg','Knife Pocket - Side','Yes'),(72,'Knife Pocket - Other Side','col-sm-6 col-xs-6 box','product-72.jpg','Knife Pocket - Other Side','Yes'),(74,'K15GRR Upper Insert','col-sm-3 col-xs-6 box','product-74.jpg','K15GRR Upper Insert','Yes'),(75,'K15GRR Upper Insert - Side','col-sm-3 col-xs-6 box','product-75.jpg','K15GRR Upper Insert - Side','Yes'),(76,'Tip Capper Cordial white cap sealer','col-sm-6 col-xs-6 box','product-76.jpg','Tip Capper Cordial white cap sealer','Yes'),(77,'Tip Capper Cordial white cap sealer - Side','col-sm-3 col-xs-6 box','product-77.jpg','Tip Capper Cordial white cap sealer - Side','Yes'),(78,'Tip Capper Cordial white cap sealer - Other Side','col-sm-3 col-xs-6 box','product-78.jpg','Tip Capper Cordial white cap sealer - Other Side','Yes');
...
insert  into `tbl_slider`(`id`,`photo`,`heading`,`content`,`button1_text`,`button1_url`,`button2_text`,`button2_url`) values (1,'slider-1.JPG','being an educator for student internship','A place for student internships from various vocational schools in Indonesia, to learn how to use CNC machines and manual machines.','Read More','csm-career','Contact Us','contact'),(2,'slider-2.JPG','HIGH PROCESSING ENGINE','Using machines that are very fast in product processing, with very high accuracy so as to create products that can compete with others.','Read More','facility','About Us','about');
...
insert  into `tbl_testimonial`(`id`,`name`,`designation`,`company`,`photo`,`comment`) values (1,'John Doe','Managing Director','ABC Inc.','testimonial-1.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit quo illo corporis nemo consectetur nobis maxime porro obcaecati accusamus, veniam impedit. Soluta esse dolorem saepe architecto similique odit quae ut.'),(2,'Dadiv Smith','CEO','SS Multimedia','testimonial-2.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit quo illo corporis nemo consectetur nobis maxime porro obcaecati accusamus, veniam impedit. Soluta esse dolorem saepe architecto similique odit quae ut.'),(3,'Stefen Carman','Chairman','GH Group','testimonial-3.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit quo illo corporis nemo consectetur nobis maxime porro obcaecati accusamus, veniam impedit. Soluta esse dolorem saepe architecto similique odit quae ut.'),(4,'Gary Brent','CFO','XYZ It Solution','testimonial-4.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit quo illo corporis nemo consectetur nobis maxime porro obcaecati accusamus, veniam impedit. Soluta esse dolorem saepe architecto similique odit quae ut.');
...
/*Data for the table `tbl_testimonial_photo` */

insert  into `tbl_testimonial_photo`(`id`,`main_photo`) values (1,'testimonial-main-photo.png');
...
insert  into `tbl_user`(`id`,`full_name`,`email`,`phone`,`password`,`photo`,`role`,`status`,`token`) values (1,'Encep Suryana','encep.suryanajr@gmail.com','082129714260','e4e05d342730456fcf3d8c87e95d5748','avatar-1.png','admin','Active',''),(2,'HRD','hrd@gmail.com','082129714260','e10adc3949ba59abbe56e057f20f883e','avatar-2.png','hrd','Active',''),(3,'Staff','staff@gmail.com','082129714260','e10adc3949ba59abbe56e057f20f883e','avatar-3.png','staff','Active',''),(4,'Admin','admin@gmail.com','082129714260','e10adc3949ba59abbe56e057f20f883e','avatar-4.png','admin','Active','');

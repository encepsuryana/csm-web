...
insert  into `tbl_partner`(`id`,`name`,`photo`) values (1,'PT Perfetti Van Melle Indonesia','partner-1.png'),(2,'PT Pakoakuina Group','partner-2.png'),(3,'PT. INFRA RCS','partner-3.png'),(4,'PT. Medion Jaya Farma','partner-4.png'),(5,'PT. Hini Daiki Indonesia','partner-5.png'),(6,'PT. Madawikri Tunggal','partner-6.png'),(7,'PT. Belfoods Indonesia','partner-7.png'),(8,'PT Nusantara Turbin Dan Propulsi','partner-8.png'),(9,'PT Heinz ABC Indonesia','partner-9.png'),(10,'PT Inkoasku','partner-10.png'),(11,'PT Deksafindo Pratama Abadi','partner-11.png'),(12,'PT Sentra Usahatama Jaya','partner-12.png'),(13,'PT Andalan Furnindo','partner-13.png'),(14,'PT Sorin Maharasa','partner-14.png'),(15,'PT Ultrajaya Milk Industry Tbk','partner-15.png'),(16,'PT King Plastic','partner-16.png'),(17,'PT Yangtze Optics Indonesia','partner-17.png');
...
insert  into `tbl_portfolio`(`id`,`name`,`short_content`,`content`,`category_id`,`photo`,`meta_title`,`meta_keyword`,`meta_description`,`slug_portfolio`) values (1,'FOOD BEVERAGE','In the production process not only made industrial equipment, but the entirety of the customer demand is definitely there.','In the production process not only made industrial equipment, but the entirety of the customer demand is definitely there. of the completeness of the manufacturing infrastructure of food, mold and other requirements we are ready to serve','1','portfolio-1.jpg','FOOD BEVERAGE','','','food-beverage.html'),(2,'AUTOMOTIVE','Our production process has always relied on customer satisfaction, and where all the requests of customers we serve, as well as in the manufacture of parts or the whole of the automotive','Our production process has always relied on customer satisfaction, and where all the requests of customers we serve, as well as in the manufacture of automotive parts or in whole. ranging from the mold and the material basis of our own manufacture of ready made','1','portfolio-2.jpg','AUTOMOTIVE','','','automotive.html'),(3,'MECHANICAL SYSTEM OF RADAR','Not just rely on the industry and we are also ready to assist the government and in the defense and security of the country.','Not just rely on the industry and we are also ready to assist the government and in the defense and security of the country. to assist in making the national radar, we are ready to strengthen the resilience and security of the country.','2','portfolio-3.jpg','MECHANICAL SYSTEM OF RADAR','','','mechanical-system-of-radar.html'),(4,'COCKPIT SIMULATOR','Improving our service also makes a Head-Up Display (HUD) for the purposes of the cockpit Casing simulator.','Improving our service also makes a Head-Up Display (HUD) for the purposes of the cockpit Casing simulator.','3','portfolio-4.jpg','COCKPIT SIMULATOR','','','cockpit-simulator.html'),(5,'RADAR DISPLAY UNIT CASING','Improving our service also makes Radar Display Unit (RDU) Casing for the purposes of cockpit simulator','in improving our service also makes Radar Display Unit (RDU) Casing for the purposes of cockpit simulator','3','portfolio-5.jpg','RADAR DISPLAY UNIT CASING','','','radar-display-unit-casing.html');

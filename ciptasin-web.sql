...
insert  into `tbl_product`(`product_id`,`product_caption`,`product_style`,`product_name`,`product_desc`,`product_show_home`,`product_star`) values 
...
(3,'slider-3.jpg','COMFORT AT WORKSHOP AREA','Have a large at workshop area for comfort a production product, and for comfort each operator of the machine.','Read more','facility','Services','service'),
(4,'slider-4.JPG','Smart managing supported by  ERP system','By developed ERP Systems for integrating and automating business processes related to aspects of operations, production, and distribution. ','read more','#','contact us','contact');

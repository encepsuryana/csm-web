...
(8,'Cam machining','col-sm-3 col-xs-6 box','product-8.jpg','Cam machining with custom contour  defending to the function of machine part.','Yes'),
(9,'Can Scroll Cutter set','col-sm-6 col-xs-6 box','product-9.jpg','Can Scroll Cutter set','Yes'),
(10,'Car Wheel Cavity Mold AHT','col-sm-3 col-xs-6 box','product-10.jpg','Car Wheel Cavity Mold  after heat treatment,\r\nFinishing with special tool for cutting hard surface in the CNC Milling machine','Yes'),
...
(24,'Horn Antena Radar - Front','col-sm-3 col-xs-6 box','product-24.jpg','Horn Antenna Radar - Front\r\nMade with CNC lathe machine, from blind aluminium material up to 1 mm thickness, size about diameter  100 x 270 mm','Yes'),
...
(33,'MDM Food Processing Part','col-sm-3 col-xs-6 box','product-33.jpg','Blade for feeder raw meat material to filtered to be pure meat and bone','Yes'),
...
(38,'Pump Lube Part','col-sm-3 col-xs-6 box','product-38.jpg','Lube for transferring liquid material in the beverage industry','Yes'),
...
(41,'Radar Component','col-sm-3 col-xs-6 box','product-41.jpg','Radar Component - make from blind POM material with CNC Milling machining , size about 700x600x90 mm','Yes'),
...
(44,'ROLLER POM BLACK','col-sm-3 col-xs-6 box','product-44.jpg','Custom shape ROLLER  make with  Turning CNC machine,  good uniformity','Yes'),
...
(47,'Rotary Table','col-sm-3 col-xs-6 box','product-47.jpg','Table for balancing production line. Used to make constant production capacity','Yes'),
...
(69,'Knife Pocket - Upper','col-sm-6 col-xs-6 box','product-69.jpg','Nice Knife for trip accessories tooling, look detail on upper.','Yes'),
...
(2,'Tooling and Precision Part Machinery','By developed ERP Systems for integrating and automating business processes related to aspects of operations, production and distribution.','By developed ERP Systems for integrating and automating business processes related to aspects of operations, production, and distribution. <br>Mainly support for customizing precision machining with the ability to uniformity and reliability of the quality of machining components with programmable CNC machining&nbsp; processing, for making plastic molds and die-casting mold, for customers who want to do from design to processing on SolidWorks analysis. We will advise on efficiency improvement before execute the manufacture process.· <br>We also deal with better designs for managing mechanical engineering and automation system.','service-2.jpg','Tooling and Precision Part Machinery','','','tooling-and-precision-part-machinery.html'),

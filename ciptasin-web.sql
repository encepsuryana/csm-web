...
(1,'img-owner1.png','CEO of Cipta Sinergi Manufacturing','img-owner2.png','Deputy of Aeronautical & Electronics Engineering','img-owner3.png','Deputy of Mechanics','img-owner4.png','Deputy of Human Commercial & Human Resources');
...
(1,'Precision Part Manufacturing','To improve the quality of your production, CV. Cipta Sinergi Manufacturing offers Precision Part Manufacturing with expert solid die and dies component building professional, design and manufacturing services for progressive dies used in various industries.','','To improve the quality of your production, CV. Cipta Sinergi Manufacturing offers <b>Precision Part Manufacturing</b> with expert solid die and dies component building professional, design and manufacturing services for progressive dies used in various industries. Using state-of-the-art design manufacturing, our engineering and design team works with each customer to manufacture accurate, high quality die components and tooling customized for each application industrial component.','','service-3.jpg','Precision Part Manufacturing','','','precision-part-manufacturing.html'),
(2,'Design and Manufacture Plastic Mold','Mold & Plastic Components for industrial applications.','','<p>In addition to producing a wide range of metal products, we also provide the <b>Mold & Plastic components</b> for industry. with various requests submitted by our customers will create with a professional and with a variety of requests from customers to produce high-quality products.</p><p>With a wide range of products made previously from <b>Mold & Plastic Components</b>, we hire an experts to create concepts and applications to be implemented in the process of application of the product you want.<br></p><p><br></p>','','service-2.jpg','Design and Manufacture Plastic Mold','','','design-and-manufacture-plastic-mold.html'),
(3,'Design and Manufacture Mechanical System','Support for making tooling like dies, jig-fixture, checking fixture etc.  to help production process in the larger industry.\r\nCapable for produced precision part machinery with uniformity and reliability for semi-mass production','','<p>Mainly support customizing tooling like dies, jig, and fixture, etc. for support bigger industry.&nbsp; We are able to produce precision part machining with uniformity and reliability of the quality of machining components by CNC machining processing and other needed process.&nbsp; We will advise on efficiency improvement before executing the manufacturing process by SolidWorks analysis.<br></p><p>Mechanical systems experts with many varieties of experiences to \r\nincrease your production, with an experienced engineering team are \r\nworking on various projects to produce high-quality mechanical systems, \r\nas well as flexibility according to customers needed.</p><p>We accept various kinds of orders for mechanical systems to increase production capacity.</p><p>We also deal with better designs for managing mechanical engineering and automation system.<br></p>','','service-1.jpg','Design and Manufacture Mechanical System','','','design-and-manufacture-mechanical-system.html');

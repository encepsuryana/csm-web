...
insert  into `tbl_electronics_division`(`id`,`name`,`short_content`,`short_content_idn`,`content`,`content_idn`,`category_id`,`photo`,`meta_title`,`meta_keyword`,`meta_description`,`slug_electronics`) values 
...
insert  into `tbl_electronics_division_desc`(`id`,`electronics_division_desc_photo`,`electronics_division_desc_heading`,`ed_desc_heading_idn`,`electronics_division_desc_content`,`ed_desc_content_idn`,`mt_electronics_division_desc`,`mk_electronics_division_desc`,`md_electronics_division_desc`) values 
...
(1,'slider-1.JPG','','Menjadi Organisasi pembelajar untuk Program Praktek Kerja Industri','','Sesuai dengan nilai & budaya perusahaan, menjadi organisasi pembelajar untuk siswa maupun mahasiswa dari sekolah menengah kejuruan dan perguruan tinggi, dengan bimbingan untuk belajar bekerja di industri serta kemanan dan keselamatan dalam bekerja.','Read More','ciptasinergi-career.html','Contact Us','contact'),

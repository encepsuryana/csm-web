...
/*Table structure for table `tbl_electronics_division_id` */

DROP TABLE IF EXISTS `tbl_electronics_division_id`;

CREATE TABLE `tbl_electronics_division_id` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `short_content` text NOT NULL,
  `content` text NOT NULL,
...
/*Data for the table `tbl_electronics_division_id` */

insert  into `tbl_electronics_division_id`(`id`,`name`,`short_content`,`content`,`category_id`,`photo`,`meta_title`,`meta_keyword`,`meta_description`,`slug_electronics`) values 
(1,'PLC Controller design and implementations','design and integration PLC controlling solutions for Industrial Automation. Our engineering team is an expert on Several PLC controllers, therefore, we provide the most efficient solutions for our customers.','design and integration PLC controlling solutions for Industrial Automation. Our engineering team is an expert on Several PLC controllers, therefore, we provide the most efficient solutions for our customers. <br>','1','electronics_division-1.PNG','PLC Controller design and implementations','design and integration PLC controlling solutions for Industrial Automation. Our engineering team is an expert on Several PLC controllers, therefore, we provide the most efficient solutions for our customers. ','design and integration PLC controlling solutions for Industrial Automation. Our engineering team is an expert on Several PLC controllers, therefore, we provide the most efficient solutions for our customers. ','plc-controller-design-and-implementations.html'),
(2,'Power electronics design and manufacturing','Up to 400 Amps PWM driving \r\nInput voltage: 18-28 VDC\r\nSmart control (Current, temperature and luck sensing) \r\n...','<ul><li>Up to 400 Amps PWM driving</li><li>Input voltage: 18-28 VDC</li><li>Smart control (Current, temperature and luck sensing)</li><li>Programmable RPM controlling</li><li>Time controlling (programmable delays)</li><li>Soft and fast running, soft and fast stop</li><li>RS-422 serial interface, status and warnings report</li><li>Discrete and digital command interface (controlling by panel or computer interface)<br>Noise isolation</li><li>Harsh environmental operation ( Drop, Shock, Strike, Vibration and temperature (-20 to +60) resistant )<br></li></ul>','1','electronics_division-2.jpg','Power electronics design and manufacturing ','Power electronics design and manufacturing ','Power electronics design and manufacturing ','power-electronics-design-and-manufacturing.html'),
(3,'Man-Machine Interface','our MMI interface display panels are designed based on customer requirements in order for machinery programming and smart operations inspection.','our MMI interface display panels are designed based on customer requirements in order for machinery programming and smart operations inspection. These products are suitable for industrial automation and special vehicles and portable sets.','1','electronics_division-3.jpg','MMI (Man-Machine Interface)','MMI (Man-Machine Interface)','MMI (Man-Machine Interface)','man-machine-interface.html'),
(4,'Ruggedized electronic controllers','we design ruggedized electronic controlling and processing systems for all defense applications. Our products','we design ruggedized electronic controlling and processing systems for all defense applications. Our products Are qualified by military standards requirements. The processing systems are designed for army and naval application.<br><br>','2','electronics_division-4.jpg','Ruggedized electronic controllers','Ruggedized electronic controllers','Ruggedized electronic controllers','ruggedized-electronic-controllers.html'),
...
(1,'2019-10-23 08:37:37',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] User: 192@1 Gagal Login</span>','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0</i>'),
(2,'2019-10-23 08:37:54','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0</i>'),
(3,'2019-10-23 14:04:48',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] Error! Invalid Captcha, Robot Login detected!</span>','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0</i>'),
(4,'2019-10-23 14:04:58','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0</i>'),
(5,'2019-10-26 15:55:48','Admin',0,'[LOGIN] User: Admin Berhasil Login','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(6,'2019-10-26 16:06:32','Admin',3,'[EDIT] Data: Pump Lube Part diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(7,'2019-10-26 16:12:07','Admin',3,'[EDIT] Data: MDM Food Processing Part diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(8,'2019-10-26 16:14:20','Admin',4,'[HAPUS] Data Id: SHAFT PN 7 Bearing Housing - Closer rear dihapus dari Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(9,'2019-10-26 16:20:36','Admin',3,'[EDIT] Data: Rotary Table diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(10,'2019-10-26 16:20:49','Admin',3,'[EDIT] Data: Rotary Table diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(11,'2019-10-26 16:28:39','Admin',3,'[EDIT] Data: Cam machining diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(12,'2019-10-26 16:34:45','Admin',3,'[EDIT] Data: ROLLER POM BLACK diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(13,'2019-10-26 16:34:54','Admin',3,'[EDIT] Data: ROLLER POM BLACK diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(14,'2019-10-26 16:40:13','Admin',3,'[EDIT] Data: Radar Component diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(15,'2019-10-26 16:40:59','Admin',3,'[EDIT] Data: Radar Component diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(16,'2019-10-26 16:44:29','Admin',3,'[EDIT] Data: Horn Antena Radar - Front diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(17,'2019-10-26 16:45:21','Admin',3,'[EDIT] Data: Horn Antena Radar - Front diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(18,'2019-10-26 16:46:32','Admin',3,'[EDIT] Data: Knife Pocket - Upper diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(19,'2019-10-26 16:53:33','Admin',3,'[EDIT] Data: Air Nozzle for Boiler diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(20,'2019-10-26 16:58:28','Admin',3,'[EDIT] Data: Car Wheel Cavity Mold AHT diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(21,'2019-10-26 17:01:44','Admin',3,'[EDIT] Data: Slab Blind Bottling Marble Beat diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(22,'2019-10-26 17:01:51','Admin',3,'[EDIT] Data: Slab Blind Bottling Marble Beat diupdate pada Produk','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(23,'2019-10-28 10:49:34','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(24,'2019-10-28 10:51:49','Encep Suryana',3,'[EDIT] Halaman Tentang Perusahaan telah diupdate','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
...
(319,'2019-10-28 10:54:56','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(320,'2019-10-28 11:02:13','Encep Suryana',3,'[EDIT] Halaman Tentang Perusahaan telah diupdate','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(321,'2019-10-28 16:35:14','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(322,'2019-10-28 16:36:07','Encep Suryana',3,'[EDIT] Data: Tooling and Precision Part diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(323,'2019-10-28 16:36:46','Encep Suryana',3,'[EDIT] Data: Tooling and Precision Part Cutting Process diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(324,'2019-10-30 17:16:06','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(325,'2019-10-30 17:26:00','Encep Suryana',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(326,'2019-10-31 08:43:07',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] User: encep.suryanajr@gmail.com, Password salah, Gagal Login</span>','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(327,'2019-10-31 08:45:06','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(328,'2019-10-31 08:47:22','Encep Suryana',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(329,'2019-10-31 13:15:54','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(330,'2019-10-31 13:16:36','Encep Suryana',3,'[EDIT] Data: Tip Capper Cordial white cap sealer - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(331,'2019-10-31 13:16:40','Encep Suryana',3,'[EDIT] Data: Tip Capper Cordial white cap sealer - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(332,'2019-10-31 13:16:42','Encep Suryana',3,'[EDIT] Data: Tip Capper Cordial white cap sealer - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(333,'2019-10-31 13:22:45','Encep Suryana',3,'[EDIT] Data: Tip Capper Cordial white cap sealer - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(334,'2019-10-31 13:24:11','Encep Suryana',3,'[EDIT] Data: Tip Capper Cordial white cap sealer - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(335,'2019-10-31 13:27:19',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] Error! Invalid Captcha, Robot Login detected!</span>','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(336,'2019-10-31 13:27:38','Admin',0,'[LOGIN] User: Admin Berhasil Login','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(337,'2019-10-31 13:31:47','Encep Suryana',3,'[EDIT] Data: Tip Capper Cordial white cap sealer - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(338,'2019-10-31 13:36:30','Admin',3,'[EDIT] Data: High Speed CNC Milling Machining Center diupdate pada Fasilitas','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(339,'2019-10-31 13:43:04','Admin',3,'[EDIT] Data: CNC Turning diupdate pada Fasilitas','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(340,'2019-10-31 13:49:47','Admin',3,'[EDIT] Data: Mold and Plastic Component diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(341,'2019-10-31 14:22:26','Admin',2,'[TAMBAH] Data: Smart managing supported by  ERP system ditambahkan ke Slider','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(342,'2019-10-31 14:26:18','Admin',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(343,'2019-10-31 14:30:15','Admin',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(344,'2019-10-31 15:00:24','Admin',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(345,'2019-10-31 15:13:47','Admin',3,'[EDIT] Data: Mechanical System diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(346,'2019-10-31 15:19:43','Admin',3,'[EDIT] Data: Mechanical System diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(347,'2019-10-31 15:20:21','Admin',3,'[EDIT] Data: Mechanical System diupdate pada Layanan','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(348,'2019-10-31 15:47:42',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] Error! Invalid Captcha, Robot Login detected!</span>','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(349,'2019-10-31 15:48:00','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(350,'2019-10-31 16:09:25','Admin',3,'[EDIT] Data: Understanding CNC Milling Machine diupdate pada Berita','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(351,'2019-10-31 16:12:10','Admin',3,'[EDIT] Data: Understanding CNC Milling Machine diupdate pada Berita','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(352,'2019-10-31 16:15:16','Admin',3,'[EDIT] Data: What is CNC Turning Machine? diupdate pada Berita','192.168.1.199','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36</i>'),
(353,'2019-10-31 16:51:22','Encep Suryana',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(354,'2019-10-31 17:00:04','Encep Suryana',3,'[EDIT] Data: Mold and Plastic Component diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(355,'2019-11-01 09:35:09','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(356,'2019-11-01 10:01:23','Encep Suryana',3,'[EDIT] Data: Knife Pocket - Other Side diupdate pada Produk','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(357,'2019-11-01 10:08:59','Encep Suryana',3,'[EDIT] Data: What is CNC Turning Machine? diupdate pada Berita','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(358,'2019-11-01 10:10:25','Encep Suryana',3,'[EDIT] Data: What is CNC Turning Machine? diupdate pada Berita','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(359,'2019-11-01 10:13:44','Encep Suryana',3,'[EDIT] Data: Tooling and Precision Part Machinery diupdate pada Layanan','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(360,'2019-11-01 10:15:23','Encep Suryana',3,'[EDIT] Data: High Speed CNC Milling Machining Center diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(361,'2019-11-01 10:16:56','Encep Suryana',3,'[EDIT] Des. Divisi Elektronik diupdate','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(362,'2019-11-01 10:18:05','Encep Suryana',3,'[EDIT] Data: PLC Controller design and implementations diupdate pada Divisi Elektronik','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(363,'2019-11-01 15:56:58','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(364,'2019-11-04 10:20:21','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0</i>'),
(365,'2019-11-06 08:26:29','Admin',0,'[LOGIN] User: Admin Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(366,'2019-11-06 13:35:07',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] Error! Invalid Captcha, Robot Login detected!</span>','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(367,'2019-11-06 13:35:21','Encep Suryana',0,'[LOGIN] User: Encep Suryana Berhasil Login','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(368,'2019-11-06 14:33:43','Encep Suryana',3,'[EDIT] Data: BEING AN EDUCATOR FOR STUDENT INTERNSHIP diupdate pada Slider','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(369,'2019-11-06 14:40:22','Encep Suryana',3,'[EDIT] Data: BEING AN EDUCATOR FOR STUDENT INTERNSHIP diupdate pada Slider','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(370,'2019-11-06 14:42:47','Encep Suryana',3,'[EDIT] Data: VERTICAL MACHINING CENTER diupdate pada Slider','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(371,'2019-11-06 14:43:34','Encep Suryana',3,'[EDIT] Data: VERTICAL MACHINING CENTER diupdate pada Slider','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(372,'2019-11-06 14:44:05','Encep Suryana',3,'[EDIT] Data: COMFORT AT WORKSHOP AREA diupdate pada Slider','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(373,'2019-11-06 14:44:38','Encep Suryana',3,'[EDIT] Data: Smart managing supported by  ERP system diupdate pada Slider','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(374,'2019-11-06 15:02:17','Encep Suryana',3,'[EDIT] Data: High Speed CNC Milling Machining Center diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(375,'2019-11-06 15:03:34','Encep Suryana',3,'[EDIT] Data: CNC Turning diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(376,'2019-11-06 15:04:26','Encep Suryana',3,'[EDIT] Data: Conv. Machining Center and Surf. Grinding diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(377,'2019-11-06 15:05:13','Encep Suryana',3,'[EDIT] Data: Production Workshop and Parking Area diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(378,'2019-11-06 15:06:35','Encep Suryana',3,'[EDIT] Data: Production Workshop and Parking Area diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(379,'2019-11-06 15:07:01','Encep Suryana',3,'[EDIT] Data: Office Area diupdate pada Fasilitas','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(380,'2019-11-06 15:52:35','Encep Suryana',3,'[EDIT] Data: What is CNC Turning Machine? diupdate pada Berita','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(381,'2019-11-06 16:21:07',NULL,0,'<span style=\"background:red; color:white;\">[LOGIN] Error! Invalid Captcha, Robot Login detected!</span>','127.0.0.1','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>'),
(382,'2019-11-06 16:28:55','Encep Suryana',3,'[EDIT] Halaman Tentang Perusahaan telah diupdate','192.168.1.216','<i>Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0</i>');
...
(1,'slider-1.JPG','BEING AN EDUCATOR FOR STUDENT INTERNSHIP','Menjadi Pembimbing untuk Program Praktek Kerja Industri','The place for student internships program from vocational high schools and college, how to learn work in industrial and learn how to use CNC Machining and Conventional Machining is to work on the industrial.','Tempat untuk program magang siswa dari sekolah menengah kejuruan dan perguruan tinggi, cara belajar bekerja di industri dan belajar cara menggunakan Mesin CNC dan Mesin Konvensional adalah untuk bekerja di industri.','Read More','ciptasinergi-career.html','Contact Us','contact'),
(2,'slider-2.jpg','VERTICAL MACHINING CENTER','PUSAT MESIN VERTIKAL','Using a Machining center like CNC and Conventional Machine with professional operators to processing a production order, and high accuracy to make a product to create high quality and be to compete with others products.','Menggunakan pusat pemesinan seperti CNC dan Mesin Konvensional dengan operator profesional untuk memproses pesanan produksi, dan akurasi tinggi untuk membuat suatu produk menciptakan kualitas tinggi dan bersaing dengan produk lain.','Read More','facility','About Us','about'),
(3,'slider-3.jpg','COMFORT AT WORKSHOP AREA','KENYAMANAN DI WILAYAH WORKSHOP','Have a large at workshop area for comfort a production product, and for comfort each operator of the machine.','Memiliki luas di area bengkel untuk kenyamanan produk produksi, dan untuk kenyamanan setiap operator mesin.','Read more','facility','Services','service'),
(4,'slider-4.JPG','Smart managing supported by  ERP system','Pengelolaan cerdas didukung oleh sistem ERP','By developed ERP Systems for integrating and automating business processes related to aspects of operations, production, and distribution. ','Dengan mengembangkan Sistem ERP untuk mengintegrasikan dan mengotomatisasi proses bisnis yang terkait dengan aspek operasi, produksi, dan distribusi.','read more','#','contact us','contact');
